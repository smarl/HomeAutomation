...
// return [v]
//
// # with open('lights.csv', 'rb') as csvfile:
...
//
// def request(query):
// url_parts = list(urlparse.urlparse(root))
// url_parts[4] = urllib.urlencode(query)
//
// u = urlparse.urlunparse(url_parts)
// #print u
//
// return xmltodict.parse( urllib2.urlopen(u).read() )
//
//
